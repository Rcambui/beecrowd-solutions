...
class Beecrowd1010
{
    static void Main(string[] args)
    {
        ...
        int quantidade1 = int.Parse(info[1]);
        double preco1 = double.Parse(info[2]);

        int quantidade2 = int.Parse(info2[1]);
        double preco2 = double.Parse(info2[2]);

        double valorPagar = (quantidade1 * preco1) + (quantidade2 * preco2);

        Console.WriteLine("VALOR A PAGAR: R$ {0:F2}", valorPagar);
    }
}
