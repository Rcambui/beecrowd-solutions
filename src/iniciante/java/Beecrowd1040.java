...
public class Beecrowd1040 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Media: " + decF.format(media));
        ...
        if (media >= 7.0) {
            ...
            System.out.println("Nota do exame: " + decF.format(exame));
            ...
            System.out.println("Media final: " + decF.format(mediaFinal));
        }
        else {
            System.out.println("Aluno reprovado.");
        }
